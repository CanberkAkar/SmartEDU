...
router.route('/dashboard').get(authController.getDashboardPage);//localhost:3000/user/logout eğer route'a yeni bir veri gelirse mesela '/add' gibi yolu artık /courses/add olur
